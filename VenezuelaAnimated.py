...
df_africa = df[df["Entity"] == "Venezuela"].copy()
...
ax.set_title("Energía Renovable en Venezuela (1965 en adelante)")
ax.set_xlabel("Año")
...
# Guardar como GIF
ani.save("venezuela_renewables.gif", writer="pillow", fps=5)
